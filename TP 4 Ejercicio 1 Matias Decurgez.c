...
int main()
{
	...
	char nombre[20], apellido[20], datos[200];//La cadena "datos" almacenará los datos del archivo en la función del caso 2
	...
	do
	{
		...
		switch(opcion)
		{
			...
			case 2:
				...
				scanf("%d", &dnibuscar);//Variable que se usará para buscar este valor en el archivo
